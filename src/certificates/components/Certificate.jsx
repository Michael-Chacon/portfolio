    ...
    return (
        <section className="certificate">
            <article className="certificate__card">
                <img src="certificado java.webp" className="certificate__img" alt="Certificado Java" />
            ...
            <article className="certificate__card">
                <img src="certificado spring boot.webp" className="certificate__img" alt="Certificado Spring boot" />
                <div className="certificate__information">
            ...
            <article className="certificate__card">
                <img src="certificado azure.webp" className="certificate__img" alt="Certificado Introduction to Microsoft Azure Cloud Services" />
                <div className="certificate__information">
